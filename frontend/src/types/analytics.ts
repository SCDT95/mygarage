...
export type HoursEconomyDataPoint = components['schemas']['HoursEconomyDataPoint']
export type HoursEconomyTrend = components['schemas']['HoursEconomyTrend']
export type HoursAccumulatedDataPoint = components['schemas']['HoursAccumulatedDataPoint']
